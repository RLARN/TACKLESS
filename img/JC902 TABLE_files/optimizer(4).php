document.addEventListener('DOMContentLoaded', function() {
    var $scope = $(".dnd_module_ac19fb391befa6195cfdca81e4da74aa");
    if( $scope.find("#searchBarForm [name=keyword]").length ) {
        $scope.find("#searchBarForm [name=keyword]").attr('placeHolder', '상품을 검색해주세요.');
    }
...
(function() {
    ...
    function dndComponent() {
        var $scope = $('.dnd_module_68b5e4c4252ac66b382da8f61934f87d'),
        ...
        $('.dnd_module_68b5e4c4252ac66b382da8f61934f87d .eProductDetailInfo').live('click', function() {
...
document.addEventListener('DOMContentLoaded', function() {
    var $scope = $(".dnd_module_aaee3d7d83e7a131f918e237c2c8751f");
    // 상품상세 탭 이벤트
...
$(document).ready(function(){
    ...
    /* base header 검색 레이어 */
    $('#layout .header').find('.searchBtn .btnSearch').bind('click', function(){
